...
<<<<<<< HEAD
              ...
              <div class="carousel-caption" style="top: 70%;left: 13%;right: auto;bottom: auto;">
                    <h2 style="color: #fff;font-size: 50px;">Donate</h2>
                    <p style="color: #fff;font-size: 20px;">Donate us<br>
=======
              ...
              <div class="carousel-caption" style="top: 70%;left: 13%;right: auto;bottom: auto;">
                    <h2 style="color: #905e1b;font-size: 70px;">Donate</h2>
                    <p style="color: #ea8804;font-size: 20px;">Donate us<br>
>>>>>>> ba5a829206c43b98d6e77103bb45e429fac65bd9
                        to make education for all.</p>
                </div>
            </div>
